...
layui.define(['element',"fsConfig","fsCommon"], function(exports){
	...
	var menuConfig = {
			...
			data : [
				...
				{"menuId":"datagrid","menuName":"笔记类别管理","menuIcon":"fa-list","menuHref":"/admin/classify/index.html","parentMenuId":"11"},
				{"menuId":"datagrid2","menuName":"笔记管理","menuIcon":"fa-list","menuHref":"/admin/article/index.html","parentMenuId":"11"},
