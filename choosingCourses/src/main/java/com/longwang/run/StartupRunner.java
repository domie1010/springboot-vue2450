...
public class StartupRunner implements CommandLineRunner{
	...
	* @throws
	...
	public void loadData(){
		...
		application.setAttribute("clickArticleList", articleService.getClickArticle(10));//加载热门文章（课程点击排行）
		application.setAttribute("recommendArticleList", articleService.getRecommendArticle(10));//加载置顶原创文章（网页课程推荐）
